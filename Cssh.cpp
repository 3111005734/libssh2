...
string SSH2_HELPER::Ssh2::s_password;


void SSH2_HELPER::Ssh2::S_KbdCallback(const char *name, int name_len,
...
SSH2_HELPER::Ssh2::Ssh2(const string &srvIp, int srvPort)
...
bool SSH2_HELPER::Ssh2::Connect(const string &userName, const string &userPwd)
{
...
bool SSH2_HELPER::Ssh2::Disconnect(void)
{
	if (m_session)
	{
...
SSH2_HELPER::Channel* SSH2_HELPER::Ssh2::CreateChannel(const string &ptyType)
{
	if (NULL == m_session)
	{
		return NULL;
	...
	SSH2_HELPER::Channel *ret = new SSH2_HELPER::Channel(channel);
	ret->Read();
	return ret;
}


SSH2_HELPER::Channel::Channel(LIBSSH2_CHANNEL*channel)
	:m_channel(channel)
{

}

SSH2_HELPER::Channel::~Channel(void)
{
	if (m_channel)
	{
...
string SSH2_HELPER::Channel::Read(const string &strend, int timeout)
{
	string data;
	if (NULL == m_channel)
	{
...
bool SSH2_HELPER::Channel::Write(const string &data)
{
	if (NULL == m_channel)
	{
		return false;
